...
def generate_train_test_split():
    ...
    d_train = list((dataset_extracted / "intel/seg_train/seg_train").glob("*/*.jpg"))
    labels = [x.parent.stem for x in d_train]
    
    print(":: Dataset Class Counts: ", Counter(labels))
    
    d_test = list((dataset_extracted / "intel/seg_test/seg_test").glob("*/*.jpg"))
